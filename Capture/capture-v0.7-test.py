'''
Test version 0.7 of the capture script for the skyWATCH camera - depends on the Cfunctions.py file.
...
- saves all the glances so can see how they change.
...
while True:
    ...
    while active == True:
        ...
        if active == False:
            ...
            img_path = f".glance_{tnowfn}.jpg" #saves all the glances so i can see how the exposure changes
