...
while True:
    ...
    while active == True:
        ...
        while domestatus == False:
            ...
            logger(f"{path}/images.list",f"{path}/{img_name}") #appends path to image to file of list of images
            ...
            mode = timeoday(alt)
            logger(logname,f"Time of day: {mode} \n")
        ...
        while domestatus == True:
            ...
            logger(f"{path}/images.list","placeholder.jpg") #appends path to placeholder to file with list of images
