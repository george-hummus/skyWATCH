...
- if in night-time mode
    ...
    - detects if the dome is open (if it is sleeps for 1 min then takes a tempoary image when dome is closed to check if it has reopened)
...
templims = [[[102,202],[491,591]],[[82,182],[0,93]]] #limits for the template matching
...
while True:
    ...
    while active == False:
        ...
        if active == True:
            ...
            sleep(60) #checks sun's altitude every min
    ...
    while active == True:
        ...
        if domestatus == False:
            ...
            img_list.append(im_path) #appends path to image to list of images
            ...
            im_json(jname,img_name,timestr,skyprops,improps,prams,path)
        ...
        # CLOSED DOME MODE #
            ...
            # appends placeholder to image list and file #
            imlist.append("placeholder.jpg")
            imlist.append(f"{path}/movie.list","placeholder.jpg\n")
